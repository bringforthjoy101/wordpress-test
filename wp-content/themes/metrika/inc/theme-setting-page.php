...
function otherOptions() {
    ...
    <label id="scroll"><?php _e('Enable or Diasable NiceScroll:', 'metrika') ?>
    <select>
        <option value="false" <?php selected('false', $options['scroll']) ?>><?php _e('Disable', 'metrika') ?></option>
        <option value="true" <?php selected('true', $options['scroll']) ?>><?php _e('Enable', 'metrika') ?></option>
    </select>
    </label>
