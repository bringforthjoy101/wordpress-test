        ...
        if ($metrika_options['menu_type'] == 'no') {
            ...
            foreach ($works->posts as $works_item) {
                ...
                elseif (($large_image && !empty($video)) or !empty($video))
                    $output .= '<embed id="' . $video . '" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen allowfullscreen="true" allowscriptaccess="always" quality="high" bgcolor="#000000" name="my-video" style="" src="http://www.youtube.com/v/' . $video . '?enablejsapi=1&version=3&playerapiid=ytplayer" type="application/x-shockwave-flash">';
                    // $output .= '<embed width="480" height="360" src="http://www.youtube.com/v/' . $video . '?enablejsapi=1">';
                    // $output .= '<iframe id="youtube-player" width="480" height="360" src="http://www.youtube.com/v/' . $video . '?enablejsapi=1&version=3&playerapiid=ytplayer" frameborder="0" allowfullscreen allowscriptaccess="always"></iframe>';
                    // $output .= 'http://www.youtube.com/v/' . $video . '?enablejsapi=1';
